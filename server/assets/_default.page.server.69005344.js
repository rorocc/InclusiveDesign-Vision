      ...
      _push(serverRenderer.ssrRenderComponent(Layout, {
        ...
        default: vue.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              vue.createVNode("div", { class: "bg-rose-700-custom" }, [
                vue.createVNode("div", { class: "container mx-auto pt-20 pb-10" }, [
                  vue.createVNode(Masthead)
                ])
              ]),
              vue.createVNode("nav", { class: "flex items-center justify-between flex-wrap bg-rose-700-custom p-6" }, [
